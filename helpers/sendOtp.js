...
export const sendOtp = async (generatedOTP, phone) => {
  const message = `Dear Customer, Your OTP number is ${generatedOTP}. Please do not share it with anyone. For more info, please call us 91-7981801434, Regards Ganveer B2B`
